...
public class FooterNavigationView extends FrameLayout {
    ...
    private static final int TAB_COUNT = 4; // Manter em 4
    ...
    private void init(Context context) {
        ...
        int[] containerIds = {R.id.tab_home, R.id.tab_atividades, R.id.tab_agendamento, R.id.tab_mural};
        int[] iconIds = {R.id.icon_home, R.id.icon_atividades, R.id.icon_agendamento, R.id.icon_mural};
